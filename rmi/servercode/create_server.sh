...
# java -Djava.security.policy=java.policy -Djava.rmi.server.codebase="file:`pwd`" ResImpl.ResourceManagerImpl 5959
java -Djava.rmi.server.codebase="file:`pwd`" ResImpl.ResourceManagerImpl 5959
